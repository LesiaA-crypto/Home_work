...
def enter_task(list_to_do: list):
    ...
    состоящая из 3 циклов, в которых мы спрашиваем
    у пользователя Номер задачи, Имя задачи, Приоритет задачи.
    В конце добавляем результат в список, который передаем функции
    """
    ...
    # Второй цикл, где спрашиваем у пользователя Имя задачи задачи.
    ...
    if __name__ == "__main__":
        print("enter tast запущен, как самостоятельный модуль (программа).")
    else:
        print("enter task запущен, как встроенный модуль (программа) в другую программу.")    
